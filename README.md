...
Encapsulation: Employee data is protected using private fields and public accessors.

The reason I used abstract class is to prevent creation of generic Employee objects all over the subclasses.
